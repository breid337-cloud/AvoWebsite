import { compileTokens, tokensToCss, fontFaceCss } from '../themes/tokens.js';
...
export function buildStylesheet(theme, { brand = {}, mode = 'light', darkMode = 'auto' } = {}) {
  ...
  // Fonts first. The browser can start fetching them the moment it has this
  // file, instead of after a round trip to a second origin to learn the URL.
